...
// •	Place
	...
	$pdf->SetFont('times','',10);
	$pdf->Text(55,251,'Download this place');	
	...
	// $pdf->Cell(161, 75, 'Download13333', 0, 0, 'C', false, 'https://www.nairaland.com');	
	...
	////////////////$pdf->Text(150, 180, 'this place', 0, 0, 'C', false, 'https://www.nairaland.com');

	// $pdf->Ln(0);
	// $pdf->Ln();
	// $pdf->SetX(10);
	// $pdf->Cell(150, 180, 'this place', 0, 0, 'C', false, 'https://www.nairaland.com');
