                            ...
                            <form id = "ProcessUserInput" class= "ProcessUserInput">
                                ...
                                <div class="form-row">           
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id ="sur_name" name = "sur_name" required value=''>
                                    </div> 
                                </div> 
                                ...
                                <div class="form-row"> 
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id ="initials" name = "initials"  value=''>
                                    </div> 
                                    <div class="col-md-6 mb-3">
                                        <label>Maiden Name (if any)</label>
                                        <input type="text" class="form-control" id = "maiden_name" name = "maiden_name"  value=''>
                                    </div>
                                </div> 
                              ...
                              <div class="form-row">
                                <div class="col-md-6 md-3">
                                 ...
                                 <div class="col-md-6 md-3" >
                                    ...
                                    <input type="text" id="nationality" name='nationality' style = "height:45px;margin-bottom:10px;" class="form-control" value='' required>
                                </div>
                              </div>
                              <div class="form-row">
                                <div class="col-md-6 md-3">
                                    <label>Country of residence <span style='color:red'>*</span></label>
                                    <input type="text" id="country_of_residence" name='country_of_residence' style = "height:45px;margin-bottom:10px;" value='' class="form-control" required>    
                                </div>
                              ...
                              <div class="form-row">
                                <div class="col-md-6 md-3">
                                    ...
                                    <input type="text" class="form-control" id ="institution" name = "institution" required style = "height:45px;" value=''>
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label>Position <span style='color:red'>*</span></label>
                                    <input type="text" class="form-control" id ="position" name = "position" required value=''>
                                </div> 
                              </div>
                              ...
                              <div class="form-row">
                                <div class="col-md-6 md-3">
                                    ...
                                    <input type="text" class="form-control" id ="address1" name = "address1" required value=''>
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label>Address 2 <span style='color:red'>*</span></label>
                                    <input type="text" class="form-control" id ="address2" name = "address2" required value=''>
                                </div> 
                              </div>
                              ...
                              <div class="form-row">
                                <div class="col-md-6 md-3">
                                    ...
                                    <input type="text" class="form-control" id ="zip_code" name = "zip_code" required value=''>
                                </div>
                              ...
                              <div class="form-row">
                                ...
                                <div class="col-md-4 md-3">
                                    <label>Work.</label>
                                    <input type="text" class="form-control" id ="work" name = "work" value=''>
                                </div>
                              ...
                              <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id ="work_email" name = "work_email"  value=''>
                                </div> 
                              </div>
                              ...
                              <div class="form-row">
                                ...
                                <br><div class="form-row">
                                    <div class="col-md-4 md-3">
                                        ...
                                        <input type="text" class="form-control" id ="fullNames1" name = "fullNames1" required value=''>
                                    </div>

                                    <div class="col-md-4 mb-3">
                                        <label>Email Address <span style='color:red'>*</span></label>
                                        <input type="text" class="form-control" id ="emailAddress1" name = "emailAddress1" required value=''>
                                    </div> 

                                    <div class="col-md-4 mb-3">
                                        <label>Telephone <span style='color:red'>*</span></label>
                                        <input type="text" class="form-control" id ="telephone1" name = "telephone1" required value=''>
                                    </div> 
                                ...
                                <div class="form-row">
                                    <div class="col-md-4 md-3">
                                        <label>Full Names <span style='color:red'>*</span></label>
                                        <input type="text" class="form-control" id ="fullNames2" name = "fullNames2" required value=''>
                                    </div>

                                    <div class="col-md-4 mb-3">
                                        <label>Email Address <span style='color:red'>*</span></label>
                                        <input type="text" class="form-control" id ="emailAddress2" name = "emailAddress2" required value=''>
                                    </div> 

                                    <div class="col-md-4 mb-3">
                                        <label>Telephone <span style='color:red'>*</span></label>
                                        <input type="text" class="form-control" id ="telephone2" name = "telephone2" required value=''>
                                    </div> 
